...
public class DataUtil
{
    ...
    public static String secondsToString(final long l) {
        ...
        for (final Map.Entry<Integer, String> e : DataUtil.values.entrySet()) {
            ...
            if (iDiv >= 1) {
                ...
                sb.append(String.valueOf(String.valueOf(String.valueOf(x))) + e.getValue());
                seconds -= x * e.getKey();
            }
        }
        return sb.toString();
    ...
    public static int convertTime(final Long l) {
        final int time = (int)((l - System.currentTimeMillis()) / 1000L);
        return time;
    }
}
